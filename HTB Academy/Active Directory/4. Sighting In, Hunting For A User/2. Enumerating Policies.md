...
```shell
slomkm@htb[/htb]$ crackmapexec smb 172.16.5.5 -u avazquez -p Password123 --pass-pol
...
```shell-session
slomkm@htb[/htb]$ enum4linux-ng -P 172.16.5.5 -oA ilfreight
...
```shell-session
slomkm@htb[/htb]$ cat ilfreight.json 
