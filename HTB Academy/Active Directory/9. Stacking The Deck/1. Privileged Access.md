...
![[Z Assets/Images/c5c9615f39ce35b0ad7137f73e0a1e91_MD5.webp]]
...
![[Z Assets/Images/a2097b2aae1d848c83dc9eccb10abb85_MD5.webp]]
...
![[Z Assets/Images/7c52e19552e3bb96f83536c2df455782_MD5.webp]]
...
![[Z Assets/Images/85672fd6e164fadd7d3e5c4d84dbc5f7_MD5.webp]]
...
```shell-session
slomkm@htb[/htb]$ gem install evil-winrm
```
...
```shell-session
slomkm@htb[/htb]$ evil-winrm -i 10.129.201.234 -u forend
...
![[Z Assets/Images/da391a98e94dd6d976e328d7ec890e71_MD5.webp]]
...
```shell-session
slomkm@htb[/htb]$ mssqlclient.py INLANEFREIGHT/DAMUNDSEN@172.16.5.150 -windows-auth
