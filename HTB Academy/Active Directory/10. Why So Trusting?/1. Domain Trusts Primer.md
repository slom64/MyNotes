...
| Trust Type    | Scope                               | Direction    | Transitive?                | Common Use Case                                                                         |
| ------------- | ----------------------------------- | ------------ | -------------------------- | --------------------------------------------------------------------------------------- |
| **External**  | Domain ↔ Domain                     | One/two      | ❌ No                       | Limited trust between 2 domains (e.g., partner company)<br>"For external Collaboration" |
| **Tree-Root** | Tree root ↔ Tree root (same forest) | Always 2-way | ✅ Yes                      | Automatically created when adding new domain tree<br>"For same company forest"          |
| **Forest**    | Forest root ↔ Forest root           | One/two      | ✅ Yes (within each forest) | Large-scale org-to-org trust <br>"For external Collaboration"                           |
...
![[Z Assets/Images/e78fd9c0db66cbed215531ff0cbcd18f_MD5.png]]
...
![[Z Assets/Images/b01e067cede676f01f2967155808b300_MD5.png]]
...
![[Z Assets/Images/5725456b3a4eb6f3506d58125fea1f45_MD5.webp]]
