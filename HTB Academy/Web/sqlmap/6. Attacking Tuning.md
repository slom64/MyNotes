...
```shell-session
slomkm@htb[/htb]$ sqlmap -u www.example.com/?id=1 -v 3 --level=5
...
```shell-session
slomkm@htb[/htb]$ sqlmap -u www.example.com/?id=1 -v 3
...SNIP...
...
```shell-session
slomkm@htb[/htb]$ sqlmap -u www.example.com/?id=1
...SNIP...
...
```shell-session
slomkm@htb[/htb]$ sqlmap -u www.example.com/?id=1 --level=5 --risk=3
