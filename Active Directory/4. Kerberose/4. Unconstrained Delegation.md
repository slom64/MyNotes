...
if you have SPN, keep in mind you can perform S4U2self, so you can request a ticket for any user. But if you don't have SPN, you can create fake SPN in fake computer then 


---
## Computers unconstriand Delegation
**Attack Targets**:
- **Target Domain cotrollers**.
